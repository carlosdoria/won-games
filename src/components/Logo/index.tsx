  ...
  return (
    <S.Wrapper color={color}>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 158 48">
        ...
        <path stroke="#fff" strokeLinecap="round" strokeOpacity=".4" strokeWidth="1.5" d="M7.592 7.103c-5.11 2.755-4.519 5-4.519 7.5M57.274 26.103v1M3.052 18.103v2M57.274 30.103v5"/>
